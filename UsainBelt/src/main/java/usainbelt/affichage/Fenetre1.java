...
public class Fenetre1 extends JPanel {
    ...
    public JLabel distanceValeurs1;
    public JLabel vitesseValeurs1;
    public JLabel caloriesValeurs1;
    public JGraph graph1;
    public JPanel panel1;
    public JHistogram graph2;
    public JPanel panel2;
    public JLabel distanceValeurs2;
    public JLabel vitesseValeurs2;
    ...
    public Fenetre1() {
        ...
        graph1 = new JGraph("VITESSE", Color.BLUE, 0, 100);
        ...
        distanceValeurs1 = new JLabel("180 km");
        JLabel vitesseTexte1 = new JLabel("Vitesse moyenne");
        vitesseValeurs1 = new JLabel("60 km/h");
        JLabel caloriesTexte1 = new JLabel("Calories brûlées");
        caloriesValeurs1 = new JLabel("456 Kcal");
        ...
        graph2 = new JHistogram("DISTANCE PARCOURUE DURANT LES 7 DERNIERES SEANCES", Color.RED, 100);
        ...
        distanceValeurs2 = new JLabel("1090 km");
        JLabel vitesseTexte2 = new JLabel("Allure moyenne");
        vitesseValeurs2 = new JLabel("6 min/km");
