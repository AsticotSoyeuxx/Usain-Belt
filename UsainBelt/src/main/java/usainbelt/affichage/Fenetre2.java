...
public class Fenetre2 extends JPanel {
    ...
    public Fenetre2() throws IOException {
        ...
        LinkedList[] arrLatLong = Main.bdd.getLatLong(16); // par défaut
    ...
    public void updateFenetre2(){
        LinkedList<Double>[] arr = Main.bdd.getLatLong(Main.idLastSeance);
