...
public class JHistogram extends JPanel{
    ...
    public LinkedList<Integer> valeurs = new LinkedList<Integer>(); // Valeurs pour les 7 jours de la semaine
    public LinkedList<String> textes = new LinkedList<String>(); // Mots à afficher sous ces 7 valeurs
    final Color couleur;
    final float maxU;
    int interLigne = 10;
    ...
    protected void paintComponent(Graphics gr) {
        ...
        for (String t : textes) {
            ...
            int decalage = metrics.stringWidth(t)/2;
            g.drawString(t,MARGE + k*largeurIntervalle - largeurIntervalle/2 - decalage,hauteur-MARGE+18);
            k++;
        }
